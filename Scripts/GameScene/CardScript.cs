...
public class CardScript : MonoBehaviour
{
    ...
    private void Start()
    {
        //transform.SetParent(GameObject.Find("Player").transform.Find("Hero").transform.Find("Canvas").transform.Find("Hero").GetComponent<PhotonView>().IsMine ? GameObject.Find("Player").transform.Find("Hand").transform.Find("Canvas").transform.Find("HandUI").transform : GameObject.Find("Opponent").transform.Find("Hand").transform.Find("Canvas").transform.Find("HandUI").transform);
        //transform.SetParent(transform.root.name == "Player" ? GameObject.Find("Player").transform.Find("Hand").transform.Find("Canvas").transform.Find("HandUI").transform : GameObject.Find("Opponent").transform.Find("Hand").transform.Find("Canvas").transform.Find("HandUI").transform);
        mana = card.mana;
        attack = card.attack;
        hp = card.hp;
        maxHP = card.hp;
    ...
    private void Update()
    {
        ...
        if (GetComponent<RawImage>().enabled)
        {
            ...
            transform.Find("Attack").gameObject.SetActive(card.cardType == CardType.MINION && ((GameplayManager.turn == Turn.PLAYER && transform.root.name == "Player" || GameplayManager.turn == Turn.OPPONENT && transform.root.name == "Opponent")));
            transform.Find("Health").gameObject.SetActive(card.cardType == CardType.MINION && ((GameplayManager.turn == Turn.PLAYER && transform.root.name == "Player" || GameplayManager.turn == Turn.OPPONENT && transform.root.name == "Opponent")));
    ...
    public void MouseDownCard()
    {
        if ((GameplayManager.turn == Turn.PLAYER && transform.root.name == "Player") || (GameplayManager.turn == Turn.OPPONENT && transform.root.name == "Opponent"))
        {
            ...
            _bigCardPrefab.GetComponent<CardPrefabBigScript>().hp = card.hp;
            _bigCardPrefab.GetComponent<CardPrefabBigScript>().maxHP = card.hp;
